  ...
  try {
    ...
    const tenant = await prisma.tenant.upsert({
      ...
      create: {
        ...
        slug: 'airport-hills',
        status: 'ACTIVE',
        settings: { branding: { primaryColor: '#008080', secondaryColor: '#FFD700' } },
      },
    });
    ...
    const sysAdmin = await prisma.user.create({
      data: {
        ...
        status: 'ACTIVE',
        roles: {
          create: { systemRole: 'SYSTEM_OWNER' }
        }
      }
    });
    ...
    const receptionist = await prisma.user.create({
      data: {
        ...
        tenantId: tenant.id,
        roles: {
          create: { systemRole: 'RECEPTIONIST' }
        }
      }
    });
    ...
    const services = [
      ...
      { name: "Online Consultation", description: "Virtual dental consultation with our specialists", category: "TELECONSULT", price: 100, duration: 30 }
    ];
    ...
    console.log('Doctors:                  kwame@airporthills.com, ama@airporthills.com / doc123');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
